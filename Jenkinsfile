        ...
        stage('BuildAndTest') {
          ...
          '''
                ...
                axes {
                    axis {
                        name 'TOOLCHAIN'
                        values '14.1.0-240616', '13.3.0-240530'
                    }
                }
                stages {
                    stage('Call Pipeline') {
                        steps {
                            new Pipeline_(this).pipeline_build(
                              ...
                              "https://distortos.org/files/ci/arm-none-eabi-gcc-'${TOOLCHAIN}'.tar.xz",
                              "arm-none-eabi-gcc-'${TOOLCHAIN}'.tar.xz",
                              "$(cd arm-none-eabi-gcc-'${TOOLCHAIN}'/bin && pwd)",
                              "-q", "tmp" ,"cmake"
                              )
